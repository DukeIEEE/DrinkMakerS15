...
SoftwareSerial Genotronex(10,11); // set up our bluetooth comms
...
void setup()
{
 Genotronex.begin(9600); // setup bluetooth comms 
 Serial.begin(9600);// setup serial comms for debugging
 Genotronex.println("Drink Maker Connected... Waiting for input");
 // set up motor pins
 uint16_t i;
